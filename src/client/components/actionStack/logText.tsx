...
// Разбор строки лога: ники игроков красим в их цвет. Сервер пишет свободной
// строкой (см. game.addLog), поэтому ники узнаются по самому тексту.
...
// Кто сделал — тот, чей ник в строке назван первым: «X берёт в команду Y»,
// «X набирает 3 чел.». Карточке в стеке этого хватает, чтобы носить цвет своего
// игрока и без подсказки.
