/**
 * Тема «Сопротивления»: фон везде, где партии нет — с открытия игры и до её
 * начала, и снова после развязки. Одна тема, выбранная случайно, играет в петле
 * сколько угодно долго; следующую берём только когда музыка встаёт заново, то
 * есть от партии к партии.
 *
