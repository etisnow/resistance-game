...
// Набор «Сопротивления». Записи «Нечто» (топор, карантин, виски, паника и
// прочая рука) отсюда убраны вместе с самими картами — см. фазу 0.
const imports: {from: string; to: string}[] = [
	// Шелест бумаги: им звучит вскрытие голосов — стол разом переворачивает жетоны.
	{from: 'paper.mp3', to: 'paper.mp3'},
	// Итог миссии: чем она вскрылась, тем и звучит.
	{from: 'success.mp3', to: 'missionSuccess.mp3'},
	{from: 'failure.mp3', to: 'missionFail.mp3'},
	// Выстрела Убийцы здесь нет: его запись начинается с трети секунды тишины, и
	// срезает её отдельный скрипт — см. cutGunshotSound.
	// Развязка партии: чей верх, тот и звучит. Записи достались от «Нечто» и ждут
	// своей замены вместе с остальным звуковым стилем.
