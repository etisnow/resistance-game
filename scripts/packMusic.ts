 ...
 * музыка — это минута звука против секунды у эффектов, и её вес решает не тег с
 * обложкой, а битрейт. Исходник nechto.mp3 сведён под прослушивание (VBR около
 * 270 кбит/с, 1.9 МБ) — для фона в браузерной игре это впустую скачанные
 * мегабайты.
 *
